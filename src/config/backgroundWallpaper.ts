...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	common: {
		...
		homeText: {
			...
			// 主页横幅副标题
			subtitle: [
				"Beneath the Silver Moon, We Gaze as One",
				"Amidst the Drifting Stars, We Find Our Path",
				"Upon the Gentle Waves, We Drift Along",
				"Through the Endless Skies, Our Hearts Entwine",
				"In the Softest Twilight, We Whisper Dreams",
				"Across the Time, Our Love Remains True",
				"人间忽晚，山河已秋"
			],
			// 主页横幅副标题字体大小
			subtitleSize: "1.5rem",
